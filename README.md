...
Скрипт обеспечивает регистрацию DNS-записи для клиентского доступа и позволяет использовать один или более виртуальных IP-адресов, расположенных в разных подсетях.
